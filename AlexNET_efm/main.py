...
from models import Discriminator, AlexNetClassifier, AlexNetEncoder
...
if __name__ == '__main__':
    ...
    # load models
    src_encoder = init_model(net=AlexNetEncoder(),
                             restore=params.src_encoder_restore)
    src_classifier = init_model(net=AlexNetClassifier(),
                                restore=params.src_classifier_restore)
    tgt_encoder = init_model(net=AlexNetEncoder(),
